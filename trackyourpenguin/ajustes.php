...
if( $post ) {
	...
	}elseif( ! preg_match('/^[A-Za-z\d\s\.]{3,10}$/', $nombre ) ) {
		agregar_error("Los caracteres del nombre no son válidos");
...
<form method="POST" class="form-horizontal">
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="nombre" value="<?php echo ($post) ? @$_POST['nombre'] : $c->titulo ?>" maxlength="20" required="required" 
			pattern="[A-Za-z\d\s\.]{3,10}" id="url">
